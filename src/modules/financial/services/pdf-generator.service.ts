...
export class PdfGeneratorService implements OnModuleInit, OnModuleDestroy {
    ...
    async generateRiskProfileSimulationPdfBuffer(
        clientData: import('../dto/create-risk-profile-simulation.dto').CreateRiskProfileSimulationDto,
        result: import('../dto/risk-profile-response.dto').RiskProfileResponseDto,
        agent: User
    ): Promise<Buffer> {
