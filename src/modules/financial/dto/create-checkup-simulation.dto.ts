 ...
 * * [PENTING] Semua field aset/utang harus didefinisikan di sini.
 * Jika tidak, NestJS ValidationPipe akan menghapusnya (stripping), 
...
export class CreateCheckupSimulationDto {
    ...
    // Menggunakan @IsOptional() + @Type(() => Number) agar robust terhadap input form
