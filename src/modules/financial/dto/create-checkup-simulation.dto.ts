...
// Enums untuk standarisasi input (bisa dipindah ke shared constant jika perlu)
export enum Gender {
    MALE = 'L',
    FEMALE = 'P',
}
...
export class CreateCheckupSimulationDto {
    ...
    // Field di bawah ini mencerminkan struktur 'FinancialRecord' 
    // namun divalidasi ketat sebagai number >= 0.
