...
import { JwtAuthGuard } from '../../modules/auth/guards/jwt-auth.guard'; // Pastikan path import benar
import { RolesGuard } from '../../common/guards/roles.guard'; 
import { Roles } from '../../common/decorators/roles.decorator';
import { GetUser } from '../../common/decorators/get-user.decorator'; // Decorator custom user
...
export class DirectorController {
  ...
  // ===========================================================================
  // 0. DASHBOARD ORCHESTRATOR (Load All Data)
  // ===========================================================================
  ...
  async getEmployeeAuditDetail(
    @GetUser() director: client.User, // Data Direksi yang sedang login
    @Param('id') targetUserId: string // ID Karyawan yang diintip
  ) {
    // Memanggil service dengan ID Aktor (Direksi) dan ID Target (Karyawan)
    // Service akan menangani pencatatan Audit Log secara otomatis
